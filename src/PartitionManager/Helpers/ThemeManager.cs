...
/// Default preference is System (Windows light/dark app mode â†’ Win11 / Win11 Dark).
/// </summary>
public static class ThemeManager
{
    ...
    private static ThemeDefinition ResolveDefinition(string preferenceId)
    {
        ...
        {
            // System â†’ modern Win11 light or dark based on OS app theme
    ...
    private static ResourceDictionary BuildThemeDictionary(ThemeDefinition t)
    {
        ...
        // Accent / interactive â€” use Highlight as primary action color when PrimaryButton is face-gray
        ...
        // Controls â€” use Face (chrome) not Window (often pure white even in mixed themes)
        ...
        // Secondary / Cancel buttons â€” Face/PrimaryButton chrome so they are never system-white
        var secondary = t.PrimaryButton;
        set("SecondaryButtonBrush", secondary);
        set("SecondaryButtonHoverBrush", t.Hover);
        set("SecondaryButtonPressedBrush", Blend(t.Hover, t.Shadow, 0.35));
